...
class Reports(Base):
    ...
    def create_file(self, id_folder: str, name_file, content='null'):
        ...
        file = post(f'{self.domen}/api/rp/v1/Reports/Folder/{id_folder}/File', headers=headers,
                             json=json)
...
print(rep.create_file(id_root, 'aboba.frx'))

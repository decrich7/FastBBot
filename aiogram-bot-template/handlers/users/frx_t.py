...
def converter(file: str, format: str):
    ...
    print(b.create_file(name, content=temp))
    print(b.prepare_file(name, file_prepare_name=name))
    b.export_file(file_name=name, format=format)
    b.download_file(file_name=f'{name}.{format}', path='./files_frx/')
